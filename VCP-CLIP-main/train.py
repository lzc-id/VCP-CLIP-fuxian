...
if __name__ == '__main__':
    ...
    # path
    parser.add_argument("--train_data_path", type=str, default="/data/coding/VCP-CLIP-main/dataset/mvisa/data", help="train dataset path")
    parser.add_argument("--val_data_path", type=str, default="/data/coding/VCP-CLIP-main/dataset/mvisa/data", help="val dataset path")
